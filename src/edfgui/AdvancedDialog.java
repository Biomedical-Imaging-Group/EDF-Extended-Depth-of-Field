	...
	private JTable getJTable() {
		...
		if (jTable == null) {
			...
			if (isColor) {
				...
				Object[][] data = { { "EDF", "Sobel" }, { "Color Treatement", "Principal Components" },
						{ "Post-Processing", "Yes" }, { "Height-Map", "Yes" }, { "Log", "Yes" } };
				jTable = new JTable(new SimpleTableModel(columnNames, data));
			}
			else {
				String[] columnNames = { "Modules", "Values" };
				Object[][] data = { { "EDF", "Sobel" }, { "Post-Processing", "Yes" }, { "Height-Map", "Yes" },
						{ "Log", "Yes" } };
				jTable = new JTable(new SimpleTableModel(columnNames, data));
			}
