...
public class Color2BW {
	...
	/**
	 * Color to Gray Scale Image Conversion by Fixed Weights provided in the Image
	 * Converter Class of ImageJ Weights: r*0.299 + g*0.587 + b*0.114
	 */
	...
	private static double[] getEigenvector(final double[][] scatterMatrix, final double eigenvalue) {
