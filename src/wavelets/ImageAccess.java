 ...
 * 
 * @author Daniel Sage Biomedical Imaging Group (BIG), Ecole Polytechnique
 *         Federale de Lausanne (EPFL), Lausanne, Switzerland More information:
 *         http://bigwww.epfl.ch/
 * 
 *         You'll be free to use this software for research and education
 *         purposes. In addition, we expect you to include a citation or
 *         acknowledgement whenever you present or publish results that are
 *         based on it.
 * 
 *         Reference: D. Sage, M. Unser, Teaching Image-Processing Programming
 *         in Java, IEEE Signal Processing Magazine, vol. 20, November 2003.
 * 
